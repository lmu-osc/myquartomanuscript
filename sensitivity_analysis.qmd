...
The analysis presented in the [electronic supplemental materials](electronic_supplemental_material.qmd) are quite similar for more elaborate imputation schemes. For the interested reader, we prepared data imputed with the `miceRanger` package.
...
See the instructions on how to use this imputed dataset in the [electronic supplemental materials](electronic_supplemental_material.qmd).
